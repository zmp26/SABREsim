...
void EffCor_9B_p8Be2plus(const char* histName = "h", int effIndex = 9, const char* effFile = "/home/zachpurcell/efficiencies/9B_p_4He_eff_0_6000_SABREres50keV_thresh100keV.txt"){
	...
	//			1 	  =		1 										=====>	efficiency for detecting first decay only (p for this case)
	//			2 	  =		2 										=====>	efficiency for detecting second decay only (a1 for this case)
	//			3 	  =		3 										=====>	efficiency for detecting third decay only (a2 for this case)
	//			4 	  = 	any 1 particle 							=====>	efficiency for detecting any 1 particle
	//			5 	  =		12 || 21 								=====>	efficiency for detecting first decay and second (p, a1 for this case)
	//			6 	  =		23 || 32 								=====>	efficiency for detecting second decay and last (a1, a2 for this case)
	//			7 	  =		13 || 31 								=====>	efficiency for detecting first decay and last (p, a2 for this case)
