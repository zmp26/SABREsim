...
for profx in x_opts:
	...
	parx = 0 if profx=="fixed" else float(profx[4:])/1000

	for profy in y_opts:

		pary = 0 if profy=="fixed" else float(profy[4:])/1000
		...
		outputlines = [
					   ...
					   f"detfile = /mnt/e/SABREsim/det/kin2mc/kin2mc_7Li3He4He6Ligs_7500keV_theta16782278_{profx}x_{profy}y.det",
					   f"treefile = /mnt/e/SABREsim/det/kin2mc/kin2mc_7Li3He4He6Ligs_7500keV_theta16782278_{profx}x_{profy}y_tree.root",
					   f"histofile = /mnt/e/SABREsim/det/kin2mc/kin2mc_7Li3He4He6Ligs_7500keV_theta16782278_{profx}x_{profy}y_histos.root",
		...
		log_file = LOG_DIR/f"SABREsim_theta16782278_{profx}x_{profy}y.log"
