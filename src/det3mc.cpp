...
const std::pair<int, int> det3mc::offsets[] = {
	...
	det3mc::det3mc(SABRE_Array* SABRE_Array_, SPS_Aperture* SPS_Aperture_, 
...
bool det3mc::ProcessParticle(Particle& p, const Vec3& origin, EventRecorder* rec, plot3mc* plotter, SimConfig* config, std::ostringstream& ss){
