...
void Lithium6_1plus(){
	...
	hData->SetTitle("Li-6 (1+) Data vs Sim;Energy (MeV);Counts");
	hData->Draw("HIST");

	hSim->SetLineColor(kYellow);
	hSim->SetLineWidth(2);
	hSim->Draw("HIST SAME");
	...
	TString outfile_root_name = "Lithium6_1plus_simVSdata.root";
	TFile *outfile_root = new TFile("Lithium6_1plus_simVSdata.root","RECREATE");
