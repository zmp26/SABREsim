...
void SABREslicer(const char* infile, const char* intree = "SABREsim", int omniscienceSort=1){
	...
	*/
	...
	t1->Branch("SabreRing_hit1", &SR1, "SabreRing_hit1/I");
	t1->Branch("SabreWedge_hit1", &SW1, "SabreWedge_hit1/I");
	...
	t2->Branch("SabreRing_hit1", &SR1, "SabreRing_hit1/I");
	t2->Branch("SabreWedge_hit1", &SW1, "SabreWedge_hit1/I");
	...
	t3->Branch("SabreRing_hit1", &SR1, "SabreRing_hit1/I");
	t3->Branch("SabreWedge_hit1", &SW1, "SabreWedge_hit1/I");
...
void autoslicer(const char* intree = "SABREsim", int omniscienceSort=1){
	...
	SABREslicer("../analyze/may21/det/b10ha_7.5MeV_9B_ex2345keV_tree.root", intree, omniscienceSort);
	SABREslicer("../analyze/may21/det/b10ha_7.5MeV_9B_ex2751keV_tree.root", intree, omniscienceSort);
	SABREslicer("../analyze/may21/det/b10ha_7.5MeV_9B_ex2780keV_tree.root", intree, omniscienceSort);
